    ...
    public partial class CreateDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedWalletMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SharedWalletMembers_FinancialAccounts_SharedWalletId",
                        column: x => x.SharedWalletId,
                        principalTable: "FinancialAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SharedWalletMembers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SplitGroups_Payments_PaymentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_FinancialAccounts_FromAccountId",
                        column: x => x.FromAccountId,
                        principalTable: "FinancialAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_FinancialAccounts_ToAccountId",
                        column: x => x.ToAccountId,
                        principalTable: "FinancialAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_PaymentGatewayTransactions_PaymentGatewayTransactionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SplitGroupId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SplitParticipants_SplitGroups_SplitGroupId",
                        column: x => x.SplitGroupId,
                        principalTable: "SplitGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SplitParticipants_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentGatewayTransactions_GatewayTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedWalletMembers_SharedWalletId_UserId",
                table: "SharedWalletMembers",
                columns: new[] { "SharedWalletId", "UserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SplitGroups_PaymentId",
                table: "SplitGroups",
                column: "PaymentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SplitParticipants_SplitGroupId_UserId",
                table: "SplitParticipants",
                columns: new[] { "SplitGroupId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SplitParticipants_UserId",
                table: "SplitParticipants",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_PaymentGatewayTransactionId",
                table: "Transactions",
